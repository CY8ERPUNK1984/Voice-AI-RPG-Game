...
const StorySelector: React.FC<StorySelectorProps> = ({ stories, onStorySelect, isLoading = false }) => {
  ...
  const [filteredStories, setFilteredStories] = useState<readonly Story[]>(stories);
  ...
  useEffect(() => {
    let filtered: readonly Story[] = stories;
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 bg-gray-800 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400"
          />
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredStories.map(story => (
            <div
              key={story.id}
              className="bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer border border-gray-700 hover:border-gray-600"
